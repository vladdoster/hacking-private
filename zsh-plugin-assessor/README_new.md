...
* [256color](https://github.com/chrissicool/zsh-256color) :zzz: - Enhances the terminal environment with 256 colors. It looks at the chosen TERM environment variable and sees if there is respective ncurses' terminfo with 256 colors available. The result is a multicolor terminal, if available.
...
* [abbrev-alias](https://github.com/momo-lab/zsh-abbrev-alias) :zzz: - Provides functionality similar to Vim's abbreviation expansion.
* [accurev-zsh](https://github.com/dalefukami/accurev-zsh) :zzz: - ZSH plugin for accurev.
...
* [allergen](https://github.com/stanislas/allergen) :1st_place_medal: :alarm_clock: - A collection of custom ZSH plugins to use with antigen.
* [almostontop](https://github.com/Valiev/almostontop) :zzz: - Clears previous command output every time before new command executed in shell. Inspired by alwaysontop plugin for bash.
* [ansible](https://github.com/sparsick/ansible-zsh) :hourglass_flowing_sand: - A plugin for Ansible.
* [ansiweather](https://github.com/fcambus/ansiweather) :2nd_place_medal: :hourglass: - Weather in your terminal, with ANSI colors and Unicode symbols.
...
* [antigen-git-store](https://github.com/smallhadroncollider-deprecated/antigen-git-store) :zzz: - Antigen/zsh script to store Git's current working directory. For working with Git between two computers without forcing arbitrary commits.
* [anyframe](https://github.com/mollifier/anyframe) :1st_place_medal: :zzz: - A peco/percol/fzf wrapper plugin for ZSH.
* [apache2](https://github.com/voronkovich/apache2.plugin.zsh) :zzz: - Adds aliases and functions for managing Apache2.
...
* [apple-touchbar](https://github.com/zsh-users/zsh-apple-touchbar) :zzz: - Adds MacBook Pro's touchbar support in [iTerm 2](https://iterm2.com).
...
* [asciidoctor](https://github.com/sparsick/asciidoctor-zsh) :zzz: - A plugin for AsciiDoctor.
* [async](https://github.com/mafredri/zsh-async) :2nd_place_medal: :running_man: :hourglass_flowing_sand: - Library for running asynchronous tasks in ZSH without requiring any external tools. Allows you to run multiple asynchronous jobs, enforce unique jobs (multiple instances of the same job will not run), flush all currently running jobs and create multiple workers (each with their own jobs).
* [atom-plugin](https://github.com/CorradoRossi/oh-my-zsh-atom-plugin) :zzz: - A plugin for Oh My Zsh that lets you launch a file or folder in [Atom](https://atom.io) from [iTerm 2](https://iterm2.com). It's based on the Sublime plugin. Only supports macOS.
* [atom](https://github.com/kingsj/atom_plugin.zsh) :zzz: - A plugin for the Atom editor on macOS.
* [auto-color-ls](https://github.com/gretzky/auto-color-ls) :hourglass_flowing_sand: - Automatically list directories with `colorls`.
* [auto-fu.zsh](https://github.com/hchbaw/auto-fu.zsh) :2nd_place_medal: :zzz: :briefcase: - Automatic complete-word and list-choices. Originally incr-0.2.zsh by y.fujii <y-fujii at mimosa-pudica.net>.
* [auto-ls](https://github.com/desyncr/auto-ls) :hourglass_flowing_sand: - Automatically `ls` when cding to a new directory.
* [autoenv-extended](https://github.com/zpm-zsh/autoenv) :zzz: - Extended version of the zsh-autoenv plugin.
* [autoenv](https://github.com/Tarrasch/zsh-autoenv) :2nd_place_medal: :hourglass_flowing_sand: - If a directory contains a `.env` file, it will automatically be executed when you cd into it.
* [autojump](https://github.com/wting/autojump) :2nd_place_medal: :running_man: :hourglass_flowing_sand: - A cd command that learns - easily navigate directories from the command line. Install autojump-zsh for best results.
* [autopair](https://github.com/hlissner/zsh-autopair) :1st_place_medal: :zzz: - A ZSH plugin for auto-closing, deleting and skipping over matching delimiters. Only tested on ZSH 5.0.2 or later.
* [autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) :2nd_place_medal: :hourglass: - [Fish](https://fishshell.com/)-like fast/unobtrusive autosuggestions for ZSH.
* [autoswitch-virtualenv](https://github.com/MichaelAquilina/zsh-autoswitch-virtualenv) :2nd_place_medal: :running_man: :alarm_clock: - ZSH plugin to automatically switch python virtualenvs when traversing directories.
...
* [aws-vault](https://github.com/blimmer/zsh-aws-vault) :zzz: - Plugin for [aws-vault](https://github.com/99designs/aws-vault).
* [base16](https://github.com/chriskempson/base16-shell) :2nd_place_medal: :hourglass_flowing_sand: - Adds script to allow you to change your shell's default ANSI colors but most importantly, colors 17 to 21 of your shell's 256 colorspace (if supported by your terminal). This script makes it possible to honor the original bright colors of your shell (e.g. bright green is still green and so on) while providing additional base16 colors to applications such as [Vim](https://www.vim.org).
* [basex](https://github.com/dirkk/zsh-basex) :zzz: - Adds several [BaseX](http://basex.org/) aliases for simplified usage.
* [bash](https://github.com/chrissicool/zsh-bash) :zzz: - Makes ZSH more Bash compatible. It redefines the source command to act more like Bash does. It also enables Bash completions.
* [battery_state](https://github.com/Jactry/zsh_battery_state) :zzz: - Show battery state in right-prompt.
...
* [betterbrew](https://github.com/timothyrowan/betterbrew-zsh-plugin) :zzz: - Add more command aliases for `brew`
* [bitbucket-git-helpers](https://github.com/unixorn/bitbucket-git-helpers.plugin.zsh) :zzz: - Adds helper scripts to allow you to create bitbucket PRs or open a directory in the current branch.
* [blackbox](https://github.com/StackExchange/blackbox) :2nd_place_medal: :walking_man: :alarm_clock: :briefcase: :chart_with_upwards_trend: - Stack Exchange's toolkit for storing keys/credentials securely in a git repository.
* [branch-manager](https://github.com/elstgav/branch-manager) :zzz: - A plugin for managing git branches.
* [browse-commit](https://github.com/adolfoabegg/browse-commit) :zzz: - A plugin that lets you open any commit in your browser from the command line.
* [bumblebee](https://github.com/Niverton/zsh-bumblebee-plugin) :zzz: - A plugin to toggle optirun in the command line.
* [calc](https://github.com/arzzen/calc.plugin.zsh) :zzz: - A calculator for ZSH.
* [caniuse](https://github.com/walesmd/caniuse.plugin.zsh) :zzz: - Add [Can I Use...](https://caniuse.com) support to ZSH.
...
* [cd-gitroot](https://github.com/mollifier/cd-gitroot) :zzz: - A ZSH plugin to cd to the git repository root directory.
* [cd-reporoot](https://github.com/P4Cu/cd-reporoot) :zzz: - A ZSH plugin to cd to the google-repo repository root directory.
* [cd-ssh](https://github.com/jeffwalter/zsh-plugin-cd-ssh) :zzz: - `ssh` to a server when you accidentally `cd` to it.
* [cdbk](https://github.com/MikeDacre/cdbk) :zzz: - A ZSH plugin to allow easy named directory creation - shortcuts to any directory you want.
* [cdr](https://github.com/willghatch/zsh-cdr) :zzz: - Easy setup of cdr for ZSH.
* [change-case](https://github.com/mtxr/zsh-change-case) :zzz: - Plugin for fast swap between upper and lower case in your command line. :sunglasses:
* [clean-project](https://github.com/wwilsman/zsh-clean-project) :zzz: - Remove files from projects (automatically by default). Useful for keeping `.DS_Store` and `Thumbs.db` files from cluttering your directories.
* [cmd-architect](https://github.com/psprint/zsh-cmd-architect) :1st_place_medal: :zzz: - Build commands from what's in history and at prompt, move, delete, add command segments and search history with multi-word queries.
* [colored-man-pages-mod](https://github.com/zuxfoucault/colored-man-pages_mod) :zzz: - Forked from [robbyrussell/oh-my-zsh/plugins/colored-man-pages](https://github.com/robbyrussell/oh-my-zsh/blob/master/plugins/colored-man-pages/colored-man-pages.plugin.zsh). Colorizes `man` output.
* [colored-man-pages](https://github.com/ael-code/zsh-colored-man-pages) :hourglass: - Colorize man pages.
* [colors (Tarrasch)](https://github.com/Tarrasch/zsh-colors) :zzz: - Makes it easier to colorize text from the CLI. `red foo` just works.
* [colors (zpm-zsh)](https://github.com/zpm-zsh/colors) :zzz: - Colorize output of various programs.
* [command-not-found](https://github.com/Tarrasch/zsh-command-not-found) :zzz: - mirror of the oh-my-zsh command-not-found plugin so you don't have to include all of omz.
* [command-time](https://github.com/popstas/zsh-command-time) :zzz: - Show execution time for long commands in ZSH and [powerlevel9k](https://github.com/bhilburn/powerlevel9k).
...
* [copyzshell](https://github.com/rutchkiwi/copyzshell) :zzz: - A ZSH plugin to copy your shell configuration to another machine over `ssh`.
* [crash](https://github.com/molovo/crash) :zzz: - Adds proper error handling, exceptions and try/catch for ZSH.
* [crayon-syntax-zsh](https://github.com/gsemet/crayon-syntax-zsh) :zzz: - ZSH syntax highlighting for the Crayon Plugin for Wordpress.
...
* [crystal](https://github.com/veelenga/crystal-zsh) :zzz: - A plugin for [Crystal](https://github.com/crystal-lang/crystal).
* [czhttpd](https://github.com/jsks/czhttpd) :2nd_place_medal: :running_man: :alarm_clock: - A simple http server written in 99.9% pure ZSH.
...
* [deer](https://github.com/Vifon/deer) :2nd_place_medal: :hourglass: - A file navigator for ZSH heavily inspired by [ranger](https://ranger.github.io/).
* [depot-tools](https://github.com/kuoe0/zsh-depot-tools) :2nd_place_medal: :hourglass_flowing_sand: - Simple oh-my-zsh plugin for installing the chromium depot_tools. Installing this plugin will put all of the chromium depot_tools in your path automatically.
...
* [diractions](https://github.com/AdrieanKhisbe/diractions) :2nd_place_medal: :zzz: - Allow you to map a short logical/mnemonic name to directories to quickly access them, or perform actions in them.
* [dircolors-solarized](https://github.com/joel-porquet/zsh-dircolors-solarized) :zzz: - Solarized dircolors plugin.
* [dircycle](https://github.com/michaelxmcbride/zsh-dircycle) :hourglass_flowing_sand: - Cycle through the directory stack.
* [directory-history](https://github.com/tymm/zsh-directory-history) :1st_place_medal: :zzz: - A per directory history for ZSH.
...
* [dirstack](https://github.com/gepoch/oh-my-zsh-dirstack) :zzz: - Plugin for displaying dirstack info on a single line.
* [docker-aliases](https://github.com/webyneter/docker-aliases) :1st_place_medal: :zzz: Docker aliases for everyday use.
* [docker-compose](https://github.com/sroze/docker-compose-zsh-plugin) :zzz: Show docker container status in your prompt.
* [docker-helpers](https://github.com/unixorn/docker-helpers.zshplugin) :hourglass: - A collection of docker helper scripts.
* [docker-machine](https://github.com/asuran/zsh-docker-machine) :zzz: - A docker-machine plugin for ZSH.
* [docker-run](https://github.com/rawkode/zsh-docker-run) :zzz: - Go back to running your commands "naturally", we'll handle the container.
* [dogesh](https://github.com/keithhamilton/oh-my-dogesh) :zzz: - Dogification plugin.
* [dotpyvenv](https://github.com/jeanpantoja/dotpyvenv) :zzz: - If you have a `.pyvenv` virtualenv, will automagically switches to it.
* [dropbox](https://github.com/zpm-zsh/dropbox) :zzz: - A dropbox plugin for Zsh that provides `dropbox-cli` and `dropbox-uploader` commands.
* [dune-quotes](https://github.com/brokendisk/dune-quotes) :zzz: - Random Dune quote generator plugin.
* [dwim](https://github.com/oknowton/zsh-dwim) :1st_place_medal: :zzz: - zsh-dwim attempts to predict what you will want to do next. It provides a key binding (control-u) that will replace the current (or previous) command line with the command you will want to run next.
* [ec2ssh](https://github.com/h3poteto/zsh-ec2ssh) :zzz: - List EC2 instances and `ssh` login to the instances easily.
* [editing-workbench](https://github.com/psprint/zsh-editing-workbench) :1st_place_medal: :zzz: - Adds sane, complex command line editing (e.g. incremental history _word_ completion).
* [elixir-oh-my-zsh](https://github.com/gusaiani/elixir-oh-my-zsh) :1st_place_medal: :hourglass_flowing_sand: - Adds shortcuts for Elixir, IEX, Mix, Kiex and Phoenix.
* [emoji-cli](https://github.com/b4b4r07/emoji-cli) :hourglass_flowing_sand: - :scream: Emoji completion on the command line.
* [emojis](https://github.com/MichaelAquilina/zsh-emojis) :zzz: - Adds numerous ascii art emojis to your environment in convenient variables.
* [enhancd](https://github.com/b4b4r07/enhancd) :2nd_place_medal: :running_man: :alarm_clock: - A simple tool that provides enhanced `cd` command.
* [escape-backtick](https://github.com/bezhermoso/zsh-escape-backtick) :zzz: - Quickly insert escaped backticks when double-tapping "`".
* [exercism](https://github.com/fabiokiatkowski/exercism.plugin.zsh) :zzz: - A plugin for [exercism.io](http://exercism.io/).
* [expand-ealias](https://github.com/zigius/expand-ealias.plugin.zsh) :zzz: - Expand specific aliases with space.
...
* [fast-syntax-highlighting](https://github.com/zdharma/fast-syntax-highlighting) :2nd_place_medal: :running_man: :alarm_clock: :briefcase: - Optimized an improved `zsh-users/zsh-syntax-highlighting` – better response times, `zed/vared` can edit `10 kB` functions.
* [favorite-directories](https://github.com/seletskiy/zsh-favorite-directories) :zzz: - Fast jumps to your favorite directories.
* [firebase-zsh](https://github.com/rmrs/firebase-zsh) :zzz: - Add an indicator in the prompt that you're in a directory with a `firebase.json` file (aka "firebase project").
* [fixnumpad-osx](https://github.com/zackintosh/fixnumpad-osx.plugin.zsh/blob/master/fixnumpad-osx.plugin.zsh) :zzz: - Enables numpad keys of Apple keyboards to be recognized in ZSH.
...
* [forgit](https://github.com/wfxr/forgit) :1st_place_medal: :running_man: :alarm_clock: - Utility tool for git taking advantage of fuzzy finder [fzf](https://github.com/junegunn/fzf).
* [functional](https://github.com/Tarrasch/zsh-functional) :1st_place_medal: :zzz: - ZSH higher order functions.
...
* [fzf-marks](https://github.com/urbainvaes/fzf-marks) :1st_place_medal: :walking_man: :alarm_clock: - Little script to create, navigate and delete bookmarks in Bash and Zsh, using the fuzzy finder [fzf](https://github.com/junegunn/fzf).
* [fzf-mpd](https://github.com/anders-dc/fzf-mpd/) :zzz: - A ZSH plugin that allows you to control [mpd](https://www.musicpd.org/) using [fzf](https://github.com/junegunn/fzf).
* [fzf-widgets](https://github.com/ytet5uy4/fzf-widgets) :2nd_place_medal: :zzz: - Adds some ZLE widgets for [fzf](https://github.com/junegunn/fzf).
...
* [geeknote](https://github.com/s7anley/zsh-geeknote) :zzz: - Geeknote plugin for ZSH.
* [geometry-datetime](https://github.com/desyncr/geometry-datetime) :zzz: - [Geometry](https://github.com/geometry-zsh/geometry) datetime plugin. Shows datetime (`date` unix command) in your prompt.
...
* [get-jquery](https://github.com/voronkovich/get-jquery.plugin.zsh) :zzz: - Plugin for fast downloading jQuery library from [code.jquery.com](code.jquery.com).
* [ghost-zeus](https://github.com/fontno/ghost_zeus) :zzz: - Lets you use zeus with normal rails commands.
* [gimme](https://github.com/folixg/gimme-ohmyzsh-plugin) :zzz: - Manage Go installations with gimme.
* [git-add-remote](https://github.com/caarlos0/git-add-remote) :zzz: - Easily add the upstream remote to your git fork.
...
* [git-aliases.zsh](https://github.com/peterhurford/git-aliases.zsh) :1st_place_medal: :zzz: - Creates a lot of useful aliases for combinations of commonly used git commands.
...
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) :2nd_place_medal: :running_man: :alarm_clock: - Extra git helper scripts packaged as a plugin.
* [git-it-on.zsh](https://github.com/peterhurford/git-it-on.zsh) :1st_place_medal: :hourglass: - Adds ability to open a folder in your current branch on GitHub.
* [git-plugin](https://github.com/rcruzper/zsh-git-plugin) :zzz: - Adds some functions for git.
* [git-prompt-useremail](https://github.com/mroth/git-prompt-useremail) :zzz: - Adds prompt reminders for git user.email.
* [git-prune](https://github.com/Seinh/git-prune) :zzz: - Plugin that simplifies deleting merged branches.
* [git-scripts](https://github.com/packruler/zsh-git-scripts) :hourglass: - Adds `git-squash-branch` and `git-remove-merged` commands.
* [git-secret](https://github.com/sobolevn/git-secret) :2nd_place_medal: :running_man: :alarm_clock: :briefcase: :chart_with_upwards_trend: - A bash-tool to store your private data inside a git repository.
* [git-smart-commands](https://github.com/seletskiy/zsh-git-smart-commands) :zzz: - Adds git commands to make some common git usages more efficient.
...
* [gitfast](https://github.com/tevren/gitfast-zsh-plugin) :zzz: - Updated fork of oh-my-zsh gitfast plugin.
...
* [gitignore](https://github.com/voronkovich/gitignore.plugin.zsh) :2nd_place_medal: :running_man: :alarm_clock: - Plugin for creating `.gitignore` files.
* [gitio-zsh](https://github.com/denysdovhan/gitio-zsh) :zzz: - A ZSH plugin for generating a GitHub short URL using [git.io](https://git.io).
* [gitsync](https://github.com/washtubs/gitsync) :1st_place_medal: :zzz: - ZSH plugin to improve workflows for one person developing on the same repository on multiple machines.
* [goenv](https://github.com/bbenne10/goenv) :zzz: - Antigen plugin to manage `$GOPATH` similarly to Python's virtualenvwrapper.
* [going_places](https://github.com/or17191/going_places) :zzz: - A plugin that helps to use, create and maintain a list of shell locations.
* [gpg-agent](https://github.com/axtl/gpg-agent.zsh) :zzz: - Plugin that tries to do the right thing when it comes to setting up the GPG agent to act as an SSH agent as well on macOS.
* [gpg-crypt](https://github.com/Czocher/gpg-crypt) :zzz: - ZSH plugin to encrypt/decrypt files or directories in place.
* [grep2awk](https://github.com/joepvd/grep2awk) :1st_place_medal: :hourglass_flowing_sand: - ZLE widget to transform grep command into awk command.
* [grunt-plugin](https://github.com/clauswitt/zsh-grunt-plugin) :zzz: - Add autocompletion for grunt.
...
* [gvm (dgnest)](https://github.com/dgnest/zsh-gvm-plugin) :zzz: - gvm (Go version manager) plugin for ZSH.
* [gvm (yerinle)](https://github.com/yerinle/zsh-gvm) :zzz: - Provides autocompletion for gvm (Groovy enVironment Manager).
* [hacker-quotes](https://github.com/oldratlee/hacker-quotes) :zzz: - Outputs a hacker quote randomly when you open a terminal.
* [hadoop-plugin](https://github.com/valek/zsh-hadoop-plugin) :zzz: - Adds some convenience aliases for hadoop functions.
* [hanami-zsh](https://github.com/davydovanton/hanami-zsh) :zzz: - ZSH plugin for [hanami](http://hanamirb.org) projects.
* [hints](https://github.com/joepvd/zsh-hints) :zzz: - Display glob and parameter flags and other non completable info right under your editing buffer.
* [hipchat](https://github.com/robertzk/hipchat.zsh) :zzz: - Send hipchat messages from the shell.
* [histdb](https://github.com/larkery/zsh-histdb) :1st_place_medal: :hourglass_flowing_sand: - Stores your history in an SQLite database.
* [history-search-multi-word](https://github.com/zdharma/history-search-multi-word) :2nd_place_medal: :walking_man: :hourglass_flowing_sand: - syntax highlighted, multi-word history searcher for ZSH, bound to Ctrl-R, with advanced functions (e.g. bump of history entry to top of history).
* [history-substring-search](https://github.com/zsh-users/zsh-history-substring-search) :2nd_place_medal: :zzz: - Needs to be loaded after zsh-syntax-highlighting, or they'll both break. You'll also need to bind keys to its functions, details are in the README.md.
* [history-sync](https://github.com/wulfgarpro/history-sync) :1st_place_medal: :zzz: - An Oh My Zsh plugin for GPG encrypted, Internet synchronized ZSH history using Git.
* [history](https://github.com/b4b4r07/zsh-history) :zzz: - Extend history so that it can be queried by SQL.
* [hooks](https://github.com/willghatch/zsh-hooks) :hourglass_flowing_sand: - Add missing hooks - for plugins and personal use.
* [host-switch](https://github.com/LockonS/host-switch) :zzz: - Make it easier to switch in different `/etc/hosts` files during development.
* [hub-ci-zsh-plugin](https://github.com/raymondjcox/hub-ci-zsh-plugin) :zzz: - A simple plugin for adding hub ci-status to your ZSH theme.
* [ing](https://github.com/rummik/zsh-ing) :hourglass_flowing_sand: - `ping`, but shorter output.
* [intellij](https://github.com/mgryszko/intellij) :zzz: - Extract intellij bookmarks into markdown format.
...
* [iosctl](https://github.com/obayer/iosctl) :zzz: - Quickly access App, Data, and Log of the running simulator.
...
* [iterm-touchbar](https://github.com/iam4x/zsh-iterm-touchbar) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - Display iTerm2 feedback in the MacbookPro TouchBar (Current directory, git branch & status).
* [iterm2-colors](https://github.com/shayneholmes/zsh-iterm2colors) :zzz: - Manage your iTerm 2's color scheme from the command line.
...
* [java-zsh-plugin](https://github.com/Xetius/java-zsh-plugin) :zzz: - Adds a `setjdk` command so you can switch easily between different versions of the jdk.
...
* [jenkins-zsh](https://github.com/tomplex/jenkins-zsh) :zzz: - A jenkins plugin for ZSH, heavily inspired by the excellent jira plugin.
* [jenv-lazy](https://github.com/shihyuho/zsh-jenv-lazy) :hourglass_flowing_sand: - A ZSH plugin for lazy loading of jEnv.
* [jhipster](https://github.com/jhipster/jhipster-oh-my-zsh-plugin) :1st_place_medal: :walking_man: :alarm_clock: - Adds commands for [jHipster](https://www.jhipster.tech/).
* [jira-plus](https://github.com/gerges/oh-my-zsh-jira-plus) :zzz: - Create JIRAs from the command line.
* [jvm](https://github.com/mgryszko/jvm) :zzz: - Allows selection of JDK on macOS.
* [k](https://github.com/supercrabtree/k) :2nd_place_medal: :hourglass_flowing_sand: :briefcase: - Directory listings for ZSH with git features.
* [kill-node](https://github.com/vmattos/kill-node) :zzz: - ZSH plugin for murdering node process families.
* [kitsunebook](https://github.com/d12frosted/kitsunebook.plugin.zsh) :zzz: - KitsuneBook plugin for oh-my-zsh.
* [konsole-theme-changer](https://github.com/rocknrollMarc/zsh-konsole-theme-changer) :zzz: - Toggle konsole theme from ZSH.
* [kube-ps1](https://github.com/jonmosco/kube-ps1) :2nd_place_medal: :zzz: - ZSH plugin for kubectl that adds current context and namespace.
* [kubectl-zsh-plugin](https://github.com/mattbangert/kubectl-zsh-plugin) :zzz: - ZSH plugin for managing kubectl.
* [kubernetes](https://github.com/Dbz/zsh-kubernetes) :hourglass_flowing_sand: - Add kubernetes helper functions and aliases.
* [laradock-workspace](https://github.com/rluders/laradock-workspace-zsh) :zzz: - Provides an interface to [Laradock](http://laradock.io/)'s workspace.
* [laravel](https://github.com/crazybooot/laravel-zsh-plugin) :zzz: - Add shortcuts for Laravel 5, 5.1, 5.2 & 5.3.
...
* [lesaint-git](https://github.com/lesaint/lesaint-git) :zzz: - Replacement git plugin for Oh-My-Zsh-compatible frameworks.
* [lesaint-mvn](https://github.com/lesaint/lesaint-mvn) :zzz: - Maven plugins for Oh-My-Zsh.
* [linuxbrew](https://github.com/zpm-zsh/linuxbrew) :zzz: - Zsh plugin for [linuxbrew](http://linuxbrew.sh/).
* [listbox](https://github.com/gko/listbox) :zzz: - Listbox element for shell.
* [locate-sublime-projects-cli](https://github.com/david-treblig/locate-sublime-projects-cli) :zzz: - Allows searching for Sublime Text projects and opens them in Sublime.
* [loremipsum](https://github.com/pfahlr/zsh_plugin_loremipsum) :zzz: - Generate lorem ipsum text on the command line. Gets data from lipsum.com.
* [ls](https://github.com/zpm-zsh/ls) :hourglass_flowing_sand: - Colorizes the output of `ls`.
* [lumberjack](https://github.com/molovo/lumberjack) :zzz: - Lumberjack is a logging interface for shell scripts.
* [mac-packaging](https://github.com/Temikus/mac-packaging) :zzz: - A set of common functions used for enterprise Mac packaging with Munki.
* [macos](https://github.com/joow/macos) :zzz: - A ZSH plugin for macOS.
...
* [manydots-magic](https://github.com/knu/zsh-manydots-magic) :zzz: - A zle tweak for emulating `...'==`../..' etc.
...
* [mercurial](https://github.com/hcgraf/zsh-mercurial) :zzz: - Extracted from oh-my-zsh so you can use it without oh-my-zsh.
* [mfunc](https://github.com/hlohm/mfunc) :zzz: - Allows you to define persistent functions on-the-fly, without the need to add them to your config files. These functions are permanently available until you delete them.
...
* [monorepo-plugin](https://github.com/zilongqiu/monorepo-zsh-plugin) :zzz: - ZSH plugin for monorepo management.
* [morpho](https://github.com/psprint/zsh-morpho) :1st_place_medal: :zzz: - Terminal screen savers written in pure ZSH, and also screen saver framework.
* [msf](https://github.com/sathish09/zsh_plugins/tree/master/msf) :zzz: - Metasploit handler plugin for starting handler easily.
* [mylocation](https://github.com/fALKENdk/mylocation) :zzz: - A plugin to show your current location based on your IP address.
* [mysql-colorize](https://github.com/zpm-zsh/mysql-colorize) :zzz: - Colors for mysql tables.
* [mysql](https://github.com/voronkovich/mysql.plugin.zsh) :zzz: - Adds some functions for dealing with mysql.
...
* [navigation-tools](https://github.com/psprint/zsh-navigation-tools) :2nd_place_medal: :zzz: - Adds `htop`-like `kill`, directory bookmarks browser, multi-word incremental history searcher and more.
* [nice-exit-code](https://github.com/bric3/nice-exit-code) :zzz: - Maps exit status code to human readable string.
...
* [node](https://github.com/srijanshetty/node.plugin.zsh) :zzz: - Srijan Shetty's nodejs plugin for ZSH with caching of nvm completions and autoloading of nvm if present.
* [nodenv](https://github.com/jsahlen/nodenv.plugin.zsh) :hourglass: - Auto-load nodenv and its completions into the shell.
* [nohup](https://github.com/micrenda/zsh-nohup) :zzz: - Add `nohup` to the current command pressing `Ctrl-H`.
* [noreallyjustfuckingstopalready](https://github.com/eventi/noreallyjustfuckingstopalready) :zzz: - macOS users know the pain of trying to figure out what command actually flushes the DNS cache on their version of macOS, and this plugin makes that annoyance go away.
* [notes](https://github.com/chipsenkbeil/zsh-notes) :hourglass_flowing_sand: - Provides a quick notes editing experience in ZSH.
* [notify](https://github.com/marzocchi/zsh-notify) :1st_place_medal: :hourglass_flowing_sand: - A plugin for ZSH (on macOS and Linux) that posts desktop notifications when a command terminates with a non-zero exit status or when it took more than 30 seconds to complete, if the terminal application is in the background (or the command's terminal tab is inactive).
* [nvm-auto-use](https://github.com/tomsquest/nvm-auto-use.zsh) :zzz: - calls `nvm use` automatically whenever you enter a directory that contains an `.nvmrc` file with a string telling nvm which node to use.
* [nvm-auto](https://github.com/dijitalmunky/nvm-auto) :zzz: - Aims to alleviate needing to type `nvm use` as much as possible, especially if you often switch between versions of node.js and use `.nvmrc` files in your project to manage what version of node your project needs.
* [nvm](https://github.com/lukechilds/zsh-nvm) :2nd_place_medal: :zzz: :briefcase: - ZSH plugin for installing, updating and loading nvm.
* [oh-my-matrix](https://github.com/amstrad/oh-my-matrix) :walking_man: :hourglass_flowing_sand: - Turn your terminal into the matrix.
* [open-create-projects](https://github.com/marcossegovia/open-create-projects) :zzz: - Open/Create projects in Jetbrains.
* [open-pr](https://github.com/caarlos0/zsh-open-pr) :1st_place_medal: :zzz: - A ZSH plugin to open pull requests from command line.
* [openshift-origin](https://github.com/ryanswart/openshift-origin-zsh-plugin) :zzz: - Add a few shortcuts to common openshift origin (oc) actions.
* [opera-git-plugin](https://github.com/aswitalski/oh-my-zsh-opera-git-plugin) :zzz: - Git aliases.
* [operator](https://github.com/nivv/operator-theme) :zzz: - Clean and simple theme, works best with Menlo for Powerline.
* [opp.zsh](https://github.com/hchbaw/opp.zsh) :1st_place_medal: :hourglass: - Vim's text-objects-ish for ZSH.
* [opt-path](https://github.com/jreese/zsh-opt-path) :zzz: - Automatically add `~/opt` subpaths to your `$PATH`.
* [osx-dev](https://github.com/marshallmick007/osx-dev-zsh-plugin) :zzz: - This plugin adds some commands for maintaining various server programs on my macOS install.
* [osx](https://github.com/mwilliammyers/plugin-osx) :zzz: - Add some common macOS related aliases and functions.
* [paci](https://github.com/iloginow/zsh-paci) :zzz: - Plugin for archlinux package managers.
* [pantheon-terminal-notify](https://github.com/deyvisonrocha/pantheon-terminal-notify-zsh-plugin) :zzz: - Background notifications for long running commands. Supports Elementary OS Freya.
* [pctl](https://github.com/ytet5uy4/pctl) :zzz: - Toggle the environment variables for proxying.
* [peco-history](https://github.com/jimeh/zsh-peco-history) :zzz: - Search shell history with Peco when pressing ctrl+r.
...
* [pg](https://github.com/caarlos0-graveyard/zsh-pg) :zzz: - Adds utility functions to work with PosgreSQL.
* [phpcs](https://github.com/voronkovich/phpcs.plugin.zsh) :zzz: - Plugin for [PHP code sniffer](https://github.com/squizlabs/PHP_CodeSniffer).
...
* [pip-app](https://github.com/sharat87/pip-app) :zzz: - Makes it easy to install python applications into distinct virtualenvs so they don't conflict with any other python requirements on your system.
* [plugin-ibtool](https://github.com/rgalite/zsh-plugin-ibtool) :zzz: - Adds ibtool shortcuts to generate localized XIB files.
* [plugin-rails](https://github.com/paraqles/zsh-plugin-rails) :zzz: - ZSH plugin for Rails.
* [plugin-vscode](https://github.com/wuotr/zsh-plugin-vscode) :zzz: - Plugin for Visual Studio Code, a text editor for macOS, Windows, and Linux.
* [plugin](https://github.com/darrenbutcher/plugin) :zzz: - Creates custom oh-my-zsh plugins from a boilerplate template. Very oh-my-zsh centric, the generated plugins will need editing to work with other frameworks.
* [pretty-time-zsh](https://github.com/sindresorhus/pretty-time-zsh) :zzz: - Convert seconds to a human readable string: 165392 → 1d 21h 56m 32s.
...
* [project (gko)](https://github.com/gko/project) :zzz: - Create node/python/ruby project both locally and on github(private or public repository).
...
* [pyenv-lazy-load](https://github.com/erikced/zsh-pyenv-lazy-load) :zzz: - Plugin for lazy-loading pyenv in ZSH.
...
* [randeme](https://github.com/ex-surreal/randeme) :zzz: - Chooses a random theme for each session. If you not like the chosen theme you can run `randeme_rm` to never show that theme again.
* [razer-status-code](https://github.com/michaelmcallister/razer-status-code) :zzz: - change the colour of your [Razer Mouse](https://openrazer.github.io/) based on the status of the last executed command. Requires OpenRazer linux drivers.
* [rbenv (ELLIOTTCABLE)](https://github.com/ELLIOTTCABLE/rbenv.plugin.zsh) :zzz: - A faster fork of the rbenv plugin from oh-my-zsh.
* [rbenv (jsahlen)](https://github.com/jsahlen/rbenv.plugin.zsh) :hourglass: - Variant based on the original oh-my-zsh rbenv plugin.
* [redis](https://github.com/zservices/redis) :zzz: - Will run `redis-server` pointing it to the `redis.conf` configuration file. This can be used with the [zdharma/zredis](https://github.com/zdharma/zredis) plugin to share variables between shells.
* [reentry-hook](https://github.com/RobSis/zsh-reentry-hook) :zzz: - Plugin that re-enters working directory if it has been removed and re-created.
...
* [revolver](https://github.com/molovo/revolver) :zzz: - A progress spinner for ZSH scripts.
* [ripz](https://github.com/jedahan/ripz) :zzz: - Reminds you of your aliases, so you use them more. Depends on [ripgrep](https://github.com/BurntSushi/ripgrep).
* [robo-zsh-plugin](https://github.com/shengyou/robo-zsh-plugin) :zzz: - A ZSH plugin for [Robo](https://robo.li/).
...
* [ruby-switch](https://github.com/LockonS/ruby-switch) :zzz: - Switch ruby versions and manage the PATH variable at the same time.
* [rvm-zsh](https://github.com/johnhamelink/rvm-zsh) :zzz: - Initiates RVM and adds rubygem binaries (like compass) accessible in the user's `$PATH`.
* [safe-paste](https://github.com/oz/safe-paste) :zzz: - A safe-paste plugin. See Conrad Irwin's [bracketed-paste](https://cirw.in/blog/bracketed-paste) blog post.
* [saneopt](https://github.com/willghatch/zsh-saneopt) :zzz: - Sane defaults for ZSH options, in the spirit of vim-sensible.
* [schroot](https://github.com/fshp/schroot.plugin.zsh) :zzz: - Show current chroot name in your prompt.
* [select](https://github.com/psprint/zsh-select) :zzz: - Multi-term searched selection list with approximate matching and uniq mode.
* [send.zsh](https://github.com/robertzk/send.zsh) :zzz: - Single command to git add, git commit, and git push for much faster git workflow.
* [sensei-git](https://github.com/aswitalski/oh-my-zsh-sensei-git-plugin) :zzz: - Adds many git aliases and helper shell functions.
* [setenv](https://github.com/kalpakrg/setenv) :zzz: - Runs a script when you change directories.
* [simple-agnoster](https://github.com/iwat/simple-agnoster.zsh-theme) :zzz: - Powerline-inspired simple theme with git decorations.
* [simpleserver](https://github.com/sathish09/zsh_plugins/tree/master/simpleserver) :zzz: - Plugin to easily start python SimpleHTTPServer and SimpleHTTPSServer.
* [smart-cd](https://github.com/dbkaplun/smart-cd) :zzz: - Runs `ls` and `git status` after chpwd.
* [snippets](https://github.com/willghatch/zsh-snippets) :zzz: - Command line snippet expansion.
* [solarized-man](https://github.com/zlsun/solarized-man) :zzz: - A modified version of oh-my-zsh's plugin colored-man-pages, optimized for the [solarized dark](https://github.com/altercation/solarized/blob/master/iterm2-colors-solarized/Solarized%20Dark.itermcolors) theme in terminal.
* [ssh-connect](https://github.com/gko/ssh-connect) :zzz: - A simple `ssh` manager.
* [ssh-plugin](https://github.com/paraqles/zsh-plugin-ssh) :zzz: - Plugin for `ssh`.
* [startup-timer](https://github.com/paulmelnikow/zsh-startup-timer) :zzz: - Print the time it takes for the shell to start up.
* [stashy](https://github.com/MisterRios/stashy) :hourglass: - Plugin that simplifies using `git stash`.
* [statify](https://github.com/vladmrnv/statify) :zzz: - Plugin that does basic statistical analysis.
* [sterror](https://github.com/aphelionz/strerror.plugin.zsh) :zzz: - Interprets error messages from programs and displays a human readable error message when available.
* [sublime](https://github.com/valentinocossar/sublime) :zzz: - Same as the official Sublime plugin for Oh My Zsh, but this opens files in the current Sublime window, if there is one already open.
* [sudo](https://github.com/hcgraf/zsh-sudo) :zzz: - The sudo plugin from oh-my-zsh, extracted to a standalone. Toggles `sudo` before the current/previous command by pressing *ESC-ESC* in emacs-mode or vi-command mode.
* [suffix-alias](https://github.com/srijanshetty/zsh-suffix-alias) :zzz: - Directly open files in the shell using ZSH's suffix aliases.
* [symfony](https://github.com/voronkovich/symfony.plugin.zsh) :hourglass: - ZSH plugin for Symfony 2 and 3.
* [syntax-highlighting-filetypes](https://github.com/trapd00r/zsh-syntax-highlighting-filetypes) :zzz: - ZSH syntax highlighting with dircolors in realtime.
* [syntax-highlighting](https://github.com/zsh-users/zsh-syntax-highlighting) :2nd_place_medal: :running_man: :alarm_clock: - Add syntax highlighting to your ZSH. Make sure you load this _before_ zsh-users/zsh-history-substring-search or they will both break.
* [sys-diver-zsh](https://github.com/ToruIwashita/sys-diver-zsh) :zzz: - A ZSH plugin for directory change or editor startup with only key operations using widgits without typing command.
* [sysadmin-util](https://github.com/skx/sysadmin-util) :2nd_place_medal: :hourglass_flowing_sand: - Steve Kemp's collection of tool scripts for sysadmins.
* [t32](https://github.com/chrissicool/zsh-t32) :zzz: - Plugin for the Lauterbach Trace32 toolset. It automatically registers fonts and sets all necessary environment variables to run the t32 toolset.
* [tailf](https://github.com/rummik/zsh-tailf) :zzz: - Adds `tailf` function with prefixed newlines instead of trailing newlines.
* [taskbook](https://github.com/mastern2k3/taskbook-zsh-plugin) :hourglass_flowing_sand: - Auto-completes task numbers for taskbook.
* [terminal-app](https://github.com/the8/terminal-app.zsh) :zzz: - A plugin for integrating with the new El Capitan Terminal.app features.
* [terminal-workload-report](https://github.com/LockonS/terminal-workload-report) :zzz: - A plugin that calculates and displays how many commands have been run via terminal.
...
* [timewarrior](https://github.com/svenXY/timewarrior) :zzz: - Plugin for [timewarrior](https://timewarrior.net/) a timetracking application.
...
* [titles](https://github.com/jreese/zsh-titles) :zzz: - Automatic window and tab titles for [tmux](https://tmux.github.io) and xterm-compatible terminals.
* [tmux-fork](https://github.com/sharktamer/zsh-tmux) :zzz: Standalone fork of the oh-my-zsh tmux plugin
* [tmux-rename](https://github.com/sei40kr/zsh-tmux-rename) :zzz: - Rename [tmux](https://tmux.github.io) windows automatically.
* [tmux-simple](https://github.com/TBSliver/zsh-plugin-tmux-simple) :zzz: - Simple plugin for using [tmux](https://tmux.github.io) with ZSH.
* [tmux-vim-integration](https://github.com/jsahlen/tmux-vim-integration.plugin.zsh) :zzz: - Open files in a running Vim (or NeoVim) session, from an adjacent Tmux pane
* [tmux-zsh-vim-titles](https://github.com/MikeDacre/tmux-zsh-vim-titles) :1st_place_medal: :hourglass: - Create unified terminal titles for tmux, ZSH, and Vim/NVIM, modular.
* [tmux](https://github.com/zpm-zsh/tmux/blob/master/tmux.plugin.zsh) :zzz: - Plugin for [tmux](https://tmux.github.io)
* [tmuxrepl](https://github.com/csurfer/tmuxrepl) :hourglass: - Simple ZSH plugin to have a R-EP-L tmux session.
* [travis](https://github.com/denolfe/zsh-travis) :zzz: - Opens the Travis CI page for the current repo if one exists.
* [tsm](https://github.com/RobertAudi/tsm) :1st_place_medal: :zzz: - Adds a [tmux](https://tmux.github.io) Session Manager.
* [tumult](https://github.com/unixorn/tumult.plugin.zsh) :2nd_place_medal: :hourglass_flowing_sand: - Adds tools for macOS.
* [ubuntualiases](https://github.com/GuilleDF/zsh-ubuntualiases) :zzz: - Ubuntu 16 aliases.
* [up.zsh](https://github.com/peterhurford/up.zsh) :zzz: - Adds an up command to cd multiple levels up.
* [url-highlighter](https://github.com/ascii-soup/zsh-url-highlighter) :zzz: - A plugin for the ZSH syntax highlighter that turns URLs green if they respond with a "good" status, and red otherwise. Useful for checking URL typos.
* [uvenv](https://github.com/vincentto13/uvenv.plugin.zsh) :walking_man: :hourglass_flowing_sand: - Extends the functionality of the original oh-my-zsh venv module
* [vanilli.sh](https://github.com/yous/vanilli.sh) :zzz: - A lightweight start point of shell configuration.
* [velocity](https://github.com/rahulsalvi/velocity-python) :zzz: - Powerline-based theme elements for ZSH and [tmux](https://tmux.github.io).
...
* [viexchange](https://github.com/okapia/zsh-viexchange) :zzz: - Vi mode plugin for easily swapping text between two places in the buffer, like vim-exchange.
* [vim-mode](https://github.com/softmoth/zsh-vim-mode) :1st_place_medal: :hourglass_flowing_sand: - Friendly Vi-mode bindings, adding basic Emacs keys, incremental search, mode indicators and more.
* [vim-plugin](https://github.com/nviennot/zsh-vim-plugin) :zzz: - Allows you to do `vim filename:123` to open a file with the cursor at a specific line.
* [vimman](https://github.com/yonchu/vimman) :zzz: - View vim plugin manuals (help) like man in ZSH.
* [vimto](https://github.com/laurenkt/zsh-vimto) :hourglass_flowing_sand: - Improved ZSH vim mode (bindkey -v) plugin.
* [virtualenv-mod](https://github.com/mattcl/virtualenv-mod) :zzz: - A modified virtualenv ZSH plugin for oh-my-zsh.
* [virtualenv-prompt](https://github.com/tonyseek/oh-my-zsh-virtualenv-prompt) :zzz: - A fork of the virtualenv plugin from upstream. It adds support for customizing the virtualenv prompt in oh-my-zsh themes.
* [virtualz](https://github.com/aperezdc/virtualz) :zzz: - Python virtualenv manager inspired by Virtualfish, replaces virtualenvwrapper.
* [virtuozzo-plugin](https://github.com/TamCore/virtuozzo-zsh-plugin) :zzz: - An oh-my-zsh plugin for the [virtuozzo](https://docs.virtuozzo.com/master/index.html) bare-metal virtualization system.
* [visit](https://github.com/justinpchang/visit) :hourglass_flowing_sand: - Custom plugin for faster navigation.
* [vox](https://github.com/andrewbonnington/vox.plugin.zsh) :zzz: - An oh-my-zsh plugin to control [VOX](https://vox.rocks/), a lightweight full-featured audio player for macOS that can play a variety of formats including FLAC and Ogg Vorbis.
* [vsc](https://github.com/davidtong/vsc.plugin.zsh) :zzz: - Plugin for Visual Studio Code on macOS.
* [vscode](https://github.com/qianxinfeng/zsh-vscode) :zzz: - Plugin for Visual Studio Code.
* [wack](https://github.com/leoxlin/wack) :hourglass: - Wraps `ack` command.
* [wakatime-zsh-plugin](https://github.com/sobolevn/wakatime-zsh-plugin) :zzz: - Track how much [time](https://wakatime.com/) you have spent in your terminal. Has per project stats.
* [wakatime](https://github.com/wbingli/zsh-wakatime) :zzz: - Automatic time tracking for commands in ZSH using [wakatime](https://wakatime.com/).
* [warhol](https://github.com/unixorn/warhol.plugin.zsh) :zzz: - Configures colorization with [grc](https://github.com/garabik/grc).
* [watson.zsh](https://github.com/bcho/Watson.zsh) :zzz: - A plugin for the [watson](https://github.com/TailorDev/Watson) time management system.
* [wd](https://github.com/mfaerevaag/wd) :2nd_place_medal: :walking_man: :hourglass_flowing_sand: - Warp directory lets you jump to custom directories in ZSH, without using `cd`. Why? Because `cd` seems inefficient when the folder is frequently visited or has a long path.
* [workon](https://github.com/bryanculver/workon.plugin.zsh) :zzz: - Simple utility for jumping between projects
* [yadm](https://github.com/juanrgon/yadm-zsh) :hourglass: - Displays a warning if there are local yadm configuration changes.
* [yeoman-zsh-plugin](https://github.com/edouard-lopez/yeoman-zsh-plugin) :1st_place_medal: :zzz: - Edouard Lopez's Yeoman plugin for oh-my-zsh, compatible with yeoman version ≥1.0 (includes options and command auto-completion).
* [you-should-use](https://github.com/MichaelAquilina/zsh-you-should-use) :2nd_place_medal: :running_man: :hourglass_flowing_sand: - ZSH plugin that reminds you to use those aliases you defined.
* [youtube-dl](https://github.com/joow/youtube-dl) :zzz: - Simple plugin for [youtube-dl](https://youtube-dl.org/)
* [zaw](https://github.com/zsh-users/zaw) :2nd_place_medal: :hourglass: - ZSH anything.el-like widget.
* [zce](https://github.com/hchbaw/zce.zsh) :zzz: - Vim’s EasyMotion / Emacs’s ace-jump-mode for ZSH.
* [zconvey](https://github.com/zdharma/zconvey) :2nd_place_medal: :hourglass_flowing_sand: - Adds ability to send commands to other Zsh sessions, you can use this to `cd $PWD` on all active Zshells, for example.
...
* [zero](https://github.com/arlimus/zero.zsh) :2nd_place_medal: :hourglass: - Zero is both a plugin and a theme. See the github page for installation details.
* [zgdbm](https://github.com/zdharma/zgdbm) :1st_place_medal: :zzz: - Adds GDBM as a plugin.
* [zgen-compinit-tweak](https://github.com/seletskiy/zsh-zgen-compinit-tweak) :zzz: - Make compinit run only once after all loading is done by zgen.
...
* [zinfo_line](https://github.com/kmhjs/zinfo_line) :zzz: - Makes more information available to ZSH themes.
...
* [zredis](https://github.com/zdharma/zredis) :2nd_place_medal: :zzz: - Adds Redis database support, with `database_key` <-> `shell_variable` binding. Supports all data types.
* [zshmarks](https://github.com/jocelynmallon/zshmarks) :1st_place_medal: :zzz: - A port of Bashmarks (by Todd Werth), a simple command line bookmarking plugin, for oh-my-zsh.
...
* [zsnapac](https://github.com/johnramsden/zsh-zsnapac) :zzz: - Plugin for taking ZFS pre/post upgrade snapshots on Arch Linux.
* [zsnapshot](https://github.com/psprint/zsnapshot) :zzz: - Adds command to dump the current ZSH state into a file, for later restoration by sourcing the snapshot file.
* [Ztrace](https://github.com/psprint/ztrace) :zzz: - Catches output of commands, allows to reuse that output, glue it with history content.
* [ZUI](https://github.com/zdharma/zui/) :2nd_place_medal: :zzz: - ZSH User Interface library – CGI+DHTML-like rapid TUI application development with ZSH.
...
* [pastel](https://github.com/iboyperson/pastel) - A ZSH theme inspired by [sugar-free](https://github.com/cbrock/sugar-free).
