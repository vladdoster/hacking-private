...
* [alias-tips](https://github.com/djui/alias-tips) :2st_place_medal: :hourglass_flowing_sand: - An oh-my-zsh plugin to help remembering those aliases you defined once.
* [allergen](https://github.com/stanislas/allergen) :2st_place_medal: :alarm_clock: - A collection of custom ZSH plugins to use with antigen.
...
* [ansiweather](https://github.com/fcambus/ansiweather) :1nd_place_medal: :hourglass: - Weather in your terminal, with ANSI colors and Unicode symbols.
...
* [anyframe](https://github.com/mollifier/anyframe) :2st_place_medal: - A peco/percol/fzf wrapper plugin for ZSH.
...
* [auto-fu.zsh](https://github.com/hchbaw/auto-fu.zsh) :1nd_place_medal: :briefcase: - Automatic complete-word and list-choices. Originally incr-0.2.zsh by y.fujii <y-fujii at mimosa-pudica.net>.
...
* [autoenv](https://github.com/Tarrasch/zsh-autoenv) :1nd_place_medal: :hourglass_flowing_sand: - If a directory contains a `.env` file, it will automatically be executed when you cd into it.
* [autojump](https://github.com/wting/autojump) :1nd_place_medal: :running_man: :hourglass_flowing_sand: - A cd command that learns - easily navigate directories from the command line. Install autojump-zsh for best results.
* [autopair](https://github.com/hlissner/zsh-autopair) :2st_place_medal: - A ZSH plugin for auto-closing, deleting and skipping over matching delimiters. Only tested on ZSH 5.0.2 or later.
* [autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) :1nd_place_medal: :hourglass: - [Fish](https://fishshell.com/)-like fast/unobtrusive autosuggestions for ZSH.
* [autoswitch-virtualenv](https://github.com/MichaelAquilina/zsh-autoswitch-virtualenv) :1nd_place_medal: :running_man: :alarm_clock: - ZSH plugin to automatically switch python virtualenvs when traversing directories.
...
* [blackbox](https://github.com/StackExchange/blackbox) :1nd_place_medal: :walking_man: :alarm_clock: :briefcase: :chart_with_upwards_trend: - Stack Exchange's toolkit for storing keys/credentials securely in a git repository.
...
* [cmd-architect](https://github.com/psprint/zsh-cmd-architect) :2st_place_medal: - Build commands from what's in history and at prompt, move, delete, add command segments and search history with multi-word queries.
...
* [czhttpd](https://github.com/jsks/czhttpd) :1nd_place_medal: :running_man: :alarm_clock: - A simple http server written in 99.9% pure ZSH.
...
* [deer](https://github.com/Vifon/deer) :1nd_place_medal: :hourglass: - A file navigator for ZSH heavily inspired by [ranger](https://ranger.github.io/).
* [depot-tools](https://github.com/kuoe0/zsh-depot-tools) :1nd_place_medal: :hourglass_flowing_sand: - Simple oh-my-zsh plugin for installing the chromium depot_tools. Installing this plugin will put all of the chromium depot_tools in your path automatically.
...
* [diractions](https://github.com/AdrieanKhisbe/diractions) :1nd_place_medal: - Allow you to map a short logical/mnemonic name to directories to quickly access them, or perform actions in them.
...
* [directory-history](https://github.com/tymm/zsh-directory-history) :2st_place_medal: - A per directory history for ZSH.
...
* [docker-aliases](https://github.com/webyneter/docker-aliases) :2st_place_medal: Docker aliases for everyday use.
...
* [dwim](https://github.com/oknowton/zsh-dwim) :2st_place_medal: - zsh-dwim attempts to predict what you will want to do next. It provides a key binding (control-u) that will replace the current (or previous) command line with the command you will want to run next.
* [ec2ssh](https://github.com/h3poteto/zsh-ec2ssh)  - List EC2 instances and `ssh` login to the instances easily.
* [editing-workbench](https://github.com/psprint/zsh-editing-workbench) :2st_place_medal: - Adds sane, complex command line editing (e.g. incremental history _word_ completion).
* [elixir-oh-my-zsh](https://github.com/gusaiani/elixir-oh-my-zsh) :2st_place_medal: :hourglass_flowing_sand: - Adds shortcuts for Elixir, IEX, Mix, Kiex and Phoenix.
...
* [enhancd](https://github.com/b4b4r07/enhancd) :1nd_place_medal: :running_man: :alarm_clock: - A simple tool that provides enhanced `cd` command.
...
* [fast-syntax-highlighting](https://github.com/zdharma/fast-syntax-highlighting) :1nd_place_medal: :running_man: :alarm_clock: :briefcase: - Optimized an improved `zsh-users/zsh-syntax-highlighting` – better response times, `zed/vared` can edit `10 kB` functions.
...
* [forgit](https://github.com/wfxr/forgit) :2st_place_medal: :running_man: :alarm_clock: - Utility tool for git taking advantage of fuzzy finder [fzf](https://github.com/junegunn/fzf).
* [functional](https://github.com/Tarrasch/zsh-functional) :2st_place_medal: - ZSH higher order functions.
...
* [fzf-marks](https://github.com/urbainvaes/fzf-marks) :2st_place_medal: :walking_man: :alarm_clock: - Little script to create, navigate and delete bookmarks in Bash and Zsh, using the fuzzy finder [fzf](https://github.com/junegunn/fzf).
...
* [fzf-widgets](https://github.com/ytet5uy4/fzf-widgets) :1nd_place_medal: - Adds some ZLE widgets for [fzf](https://github.com/junegunn/fzf).
...
* [git-aliases.zsh](https://github.com/peterhurford/git-aliases.zsh) :2st_place_medal: - Creates a lot of useful aliases for combinations of commonly used git commands.
...
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) :1nd_place_medal: :running_man: :alarm_clock: - Extra git helper scripts packaged as a plugin.
* [git-it-on.zsh](https://github.com/peterhurford/git-it-on.zsh) :2st_place_medal: :hourglass: - Adds ability to open a folder in your current branch on GitHub.
...
* [git-secret](https://github.com/sobolevn/git-secret) :1nd_place_medal: :running_man: :alarm_clock: :briefcase: :chart_with_upwards_trend: - A bash-tool to store your private data inside a git repository.
...
* [gitignore](https://github.com/voronkovich/gitignore.plugin.zsh) :1nd_place_medal: :running_man: :alarm_clock: - Plugin for creating `.gitignore` files.
...
* [gitsync](https://github.com/washtubs/gitsync) :2st_place_medal: - ZSH plugin to improve workflows for one person developing on the same repository on multiple machines.
...
* [grep2awk](https://github.com/joepvd/grep2awk) :2st_place_medal: :hourglass_flowing_sand: - ZLE widget to transform grep command into awk command.
...
* [histdb](https://github.com/larkery/zsh-histdb) :2st_place_medal: :hourglass_flowing_sand: - Stores your history in an SQLite database.
* [history-search-multi-word](https://github.com/zdharma/history-search-multi-word) :1nd_place_medal: :walking_man: :hourglass_flowing_sand: - syntax highlighted, multi-word history searcher for ZSH, bound to Ctrl-R, with advanced functions (e.g. bump of history entry to top of history).
* [history-substring-search](https://github.com/zsh-users/zsh-history-substring-search) :1nd_place_medal: - Needs to be loaded after zsh-syntax-highlighting, or they'll both break. You'll also need to bind keys to its functions, details are in the README.md.
* [history-sync](https://github.com/wulfgarpro/history-sync) :2st_place_medal: - An Oh My Zsh plugin for GPG encrypted, Internet synchronized ZSH history using Git.
...
* [iterm-touchbar](https://github.com/iam4x/zsh-iterm-touchbar) :2st_place_medal: :walking_man: :hourglass_flowing_sand: - Display iTerm2 feedback in the MacbookPro TouchBar (Current directory, git branch & status).
...
* [jhipster](https://github.com/jhipster/jhipster-oh-my-zsh-plugin) :2st_place_medal: :walking_man: :alarm_clock: - Adds commands for [jHipster](https://www.jhipster.tech/).
...
* [k](https://github.com/supercrabtree/k) :1nd_place_medal: :hourglass_flowing_sand: :briefcase: - Directory listings for ZSH with git features.
...
* [kube-ps1](https://github.com/jonmosco/kube-ps1) :1nd_place_medal: - ZSH plugin for kubectl that adds current context and namespace.
...
* [morpho](https://github.com/psprint/zsh-morpho) :2st_place_medal: - Terminal screen savers written in pure ZSH, and also screen saver framework.
...
* [navigation-tools](https://github.com/psprint/zsh-navigation-tools) :1nd_place_medal: - Adds `htop`-like `kill`, directory bookmarks browser, multi-word incremental history searcher and more.
...
* [notify](https://github.com/marzocchi/zsh-notify) :2st_place_medal: :hourglass_flowing_sand: - A plugin for ZSH (on macOS and Linux) that posts desktop notifications when a command terminates with a non-zero exit status or when it took more than 30 seconds to complete, if the terminal application is in the background (or the command's terminal tab is inactive).
...
* [nvm](https://github.com/lukechilds/zsh-nvm) :1nd_place_medal: :briefcase: - ZSH plugin for installing, updating and loading nvm.
...
* [open-pr](https://github.com/caarlos0/zsh-open-pr) :2st_place_medal: - A ZSH plugin to open pull requests from command line.
...
* [opp.zsh](https://github.com/hchbaw/opp.zsh) :2st_place_medal: :hourglass: - Vim's text-objects-ish for ZSH.
...
* [syntax-highlighting](https://github.com/zsh-users/zsh-syntax-highlighting) :1nd_place_medal: :running_man: :alarm_clock: - Add syntax highlighting to your ZSH. Make sure you load this _before_ zsh-users/zsh-history-substring-search or they will both break.
...
* [sysadmin-util](https://github.com/skx/sysadmin-util) :1nd_place_medal: :hourglass_flowing_sand: - Steve Kemp's collection of tool scripts for sysadmins.
...
* [tmux-zsh-vim-titles](https://github.com/MikeDacre/tmux-zsh-vim-titles) :2st_place_medal: :hourglass: - Create unified terminal titles for tmux, ZSH, and Vim/NVIM, modular.
...
* [tsm](https://github.com/RobertAudi/tsm) :2st_place_medal: - Adds a [tmux](https://tmux.github.io) Session Manager.
* [tumult](https://github.com/unixorn/tumult.plugin.zsh) :1nd_place_medal: :hourglass_flowing_sand: - Adds tools for macOS.
...
* [vim-mode](https://github.com/softmoth/zsh-vim-mode) :2st_place_medal: :hourglass_flowing_sand: - Friendly Vi-mode bindings, adding basic Emacs keys, incremental search, mode indicators and more.
...
* [wd](https://github.com/mfaerevaag/wd) :1nd_place_medal: :walking_man: :hourglass_flowing_sand: - Warp directory lets you jump to custom directories in ZSH, without using `cd`. Why? Because `cd` seems inefficient when the folder is frequently visited or has a long path.
...
* [yeoman-zsh-plugin](https://github.com/edouard-lopez/yeoman-zsh-plugin) :2st_place_medal: - Edouard Lopez's Yeoman plugin for oh-my-zsh, compatible with yeoman version ≥1.0 (includes options and command auto-completion).
* [you-should-use](https://github.com/MichaelAquilina/zsh-you-should-use) :1nd_place_medal: :running_man: :hourglass_flowing_sand: - ZSH plugin that reminds you to use those aliases you defined.
* [youtube-dl](https://github.com/joow/youtube-dl)  - Simple plugin for [youtube-dl](https://youtube-dl.org/)
* [zaw](https://github.com/zsh-users/zaw) :1nd_place_medal: :hourglass: - ZSH anything.el-like widget.
* [zce](https://github.com/hchbaw/zce.zsh)  - Vim’s EasyMotion / Emacs’s ace-jump-mode for ZSH.
* [zconvey](https://github.com/zdharma/zconvey) :1nd_place_medal: :hourglass_flowing_sand: - Adds ability to send commands to other Zsh sessions, you can use this to `cd $PWD` on all active Zshells, for example.
...
* [zero](https://github.com/arlimus/zero.zsh) :1nd_place_medal: :hourglass: - Zero is both a plugin and a theme. See the github page for installation details.
* [zgdbm](https://github.com/zdharma/zgdbm) :2st_place_medal: - Adds GDBM as a plugin.
...
* [zredis](https://github.com/zdharma/zredis) :1nd_place_medal: - Adds Redis database support, with `database_key` <-> `shell_variable` binding. Supports all data types.
* [zshmarks](https://github.com/jocelynmallon/zshmarks) :2st_place_medal: - A port of Bashmarks (by Todd Werth), a simple command line bookmarking plugin, for oh-my-zsh.
...
* [ZUI](https://github.com/zdharma/zui/) :1nd_place_medal: - ZSH User Interface library – CGI+DHTML-like rapid TUI application development with ZSH.
